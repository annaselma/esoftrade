...
public class Warehouse extends MetaObject {
	...
	@Index(name="ELMO_REF_INDEX")
	 private String ref;
	@Column(name="ELMO_NAME", nullable= false,unique=true,length= 255)
	public String name;
	@Column(name="ELMO_ADRESSE", nullable= false,unique=true,length= 255)
	public String adresse;
	@Column(name="ELMO_DESCRIPTION", nullable= false,unique=true,length= 1000)
	...
	private String city;
	@Column(name="ELMO_STATUS", nullable=false, length=255)
