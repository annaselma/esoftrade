...
<header class="header">
	<a href="${baseURL}/dashboard" class="logo"> <!-- Add the class icon to your logo image or logo icon to add the margining -->
  <img src="${baseURL}/img/softLogoNew.png" class="" alt="Image" style="width: 169px; height: 87px;/* margin-right: 17%; */margin-top: -6%;">
				    ...
				    $.ajax({ // ajax call starts
					    ...
					    .done(function(data) { // Variable data contains the data we get from serverside
					    	...
					    	data.forEach(function(entry) {
					    		  ...
					    		  message=  "OF en attente depuis <small> <code>&lt;"+entry.orderDocument.customerReference+ "&gt;</code></small> ";
					    	  $countNot+=1;
					    	  $not="<li><a href='${baseURL}/manufacturing/profile?id="+entry.id+"'> <i class='ion ion-gear-b info'></i>"+
									   message+"</a></li>";
							  updateNotification($countNot);
