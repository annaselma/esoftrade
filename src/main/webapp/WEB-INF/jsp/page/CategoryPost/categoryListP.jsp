...
<div class="box">
	<div class="box-header">
		...
		<div class="box-tools pull-right">
			<a class="btn btn-primary btn-sm" href="${baseURL}/categoryPost/create"
...
//                    } );
               ...
               var table= $('#list1').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "${baseURL}/categoryPost/getList",
                        "data": function(data) {
                            planify(data);  
                        } 
                    },
                    ...
                    
                    {
                    	...
                    	"orderable": false,
                    	 "render": function ( data, type, full, meta ) {
                    		 $html='<a href="${baseURL}/categoryPost/profile?id='+data+'"  class="btn btn-info btn-xs"><i class="fa   fa-search"></i></a>&nbsp;';
                    		 $html+='<a href="${baseURL}/categoryPost/update?id='+data+'"  class="btn btn-default btn-xs"><i class="fa   fa-edit"></i></a>&nbsp;';
                    		 $html+='<a href="${baseURL}/categoryPost/delete?id='+data+'"  class="btn btn-danger btn-xs"><i class="fa   fa-trash-o"></i></a>';
                    		 return $html;
                    	    }
