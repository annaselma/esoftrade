...
<div class="nav-tabs-custom">
	<ul id="tabs" class="nav nav-tabs">
		...
		<li class="${expActive}"><a href="#shipping" data-toggle="tab"
			aria-expanded="false"><i class="fa  fa-truck" style=""></i>&nbsp;Expédition/réception</a></li>
	...
	<div id="myTabContent" class="tab-content">
								...
								<div class=" col-sm-12 table-responsive">
									<table class="table">
										<tbody>
											...
											<tr>
												...
												<td><span class="text-muted"><c:out
															value="${order.customerReference}" /></span></td>
											</tr>
											<tr>
										...
										pattern="dd/MM/yyyy" value="${order.deliveryDate}" /></td>
											...
											<tr>
												<th><label>Méthode d'expédition:</label></th>
												<td><fmt:message key="${order.shippingMethod}" /></td>
											</tr>
											<tr>
		...
		<c:if test="${order.status!='draft' and order.status!='denied'  }">
          <form:form method="POST" commandName="expedition" action="${baseURL}/order/export"
			...
			<thead>
				<tr>
					<th>Produit</th>
					<th>Quantité à commandeé</th>
					<th>Quantité à expédieé (remplir)</th>
					<th>Entrepot</th>
				</tr>
			</thead>
			<tbody>
			<c:forEach items="${expedition.expeditions}" var="exp" varStatus="i" >
			      <tr>  
			        <td>
			        <a href="${baseURL}/product/profile?id=${exp.product.id}"  ><c:out value="${exp.product.libelle}"/></a>
