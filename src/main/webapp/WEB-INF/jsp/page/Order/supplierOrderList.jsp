...
<div class="box">
	<div class="box-header">
		<h3 class="box-title">Liste des Commandes fournisseur</h3>
		<div class="box-tools pull-right">
			<a class="btn btn-primary btn-sm" href="${baseURL}/third/create?type=supplierOrder"
				style="color: white;">+ Ajouter Commande fournisseur</a> &nbsp;
		</div>
	</div>
	<!-- /.box-header -->
...
//                    } );
               ...
               var table= $('#list1').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "${baseURL}/order/getList?type=supplierOrder",
                        "data": function(data) {
                            planify(data);  
                        } 
                    },
