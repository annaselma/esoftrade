							...
							<div class="global-info">
								<div class=" col-sm-12 table-responsive">
									<div class="" style="margin-bottom: 4%;">
										<label class=""> Produit N°</label> &nbsp;<span
					...
					<div class="col-md-3">
						...
						<div class="user-info-right"
							...
							<c:choose>
								...
								<c:otherwise>
									<c:set var="imageURL"
										value="${baseURL}/file/?id=${product.picture.id}" />
								</c:otherwise>
							</c:choose>
							<img src="${imageURL}" alt="image produit" class="img-thumbnail">
							<form id="upload-image" method="POST"
								action="${baseURL}/product/image" enctype="multipart/form-data"
								class="form-inline">
				...
				<table class="table ">
					<tbody>
						...
						<tr class=" box box-solid bg-">
							...
							<td><img
								src="${baseURL}/file?id=${product.creator.picture.id}"
								class="img-circle" alt="User Image"
								style="width: 29px; height: 28px;"><span
								class="data-value label label-inverse"> <a
									href="<c:out value="${baseURL}/user/profile?id=${product.creator.id}"/>"><c:out
						...
						<tr class=" box box-solid bg-">
							...
							<td><img
								src="${baseURL}/file?id=${product.modifier.picture.id}"
								class="img-circle" alt="User Image"
								style="width: 29px; height: 28px;"><span
								class="data-value label label-important"> <a
									href="<c:out value="${baseURL}/user/profile?id=${product.modifier.id}"/>"><c:out
