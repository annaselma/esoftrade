...
<div class="box box-solid box-primary">
	<div class="box-header">
		<h3 class="box-title">Modifier tiers(client, fournisseur)</h3>
	</div>
	<!-- /.box-header -->
	<!-- form start -->
...
<span class="error">Veuillez saisir les champs obligatoire (*)</span>
		<form:form method="POST" commandName="company" id="companyF"
			data-toggle="validator" cssClass="form-horizontal">
			<div class="form-group">
				<label for="nameField" class="col-sm-2 control-label esoft-left">Nom du tiers:&nbsp;<span class="error">*</span></label>
				<div class="col-sm-4">
			...
			<div class="form-group form-horizontal">
				<label for="statut" class="col-sm-2 control-label esoft-left">Client&nbsp;</label>
				<div class="col-sm-1" >
					<form:checkbox path="customer"  cssClass="form-control" />
					<form:errors path="customer" cssClass="error" />
				</div>
				    <label for="achat" class="col-sm-2 col-sm-offset-3 control-label esoft-left">Fournisseur:&nbsp;</label>
				<div class="col-sm-1">
					<form:checkbox path="supplier" cssClass="form-control"  />
		    ...
		    <div class="form-group">
				...
				<div class="col-sm-4">
					<form:textarea path="adresse" rows="3" cols="56" />
			...
			<div class="form-group">
				...
				<label for="telField" class="col-sm-2 control-label esoft-left">Téléphone:</label>
				<div class="col-sm-4">
			...
			<hr>
			<div class="form-group">
				<label for="typeField" class="col-sm-2 control-label esoft-left">Type du tiers:&nbsp;</label>
				<div class="col-sm-4" >
					<form:select path="type" cssClass="form-control ">
						<option value="SMEs_SMIs">PME/PMI</option>
						<option value="wholesaler">Grossiste</option>
						<option value="administration">Administration</option>
						<option value="auther">autre</option>
						<option value="GE">Grand Compte</option>
						<option value="particular">Particulier</option>
					</form:select>
					<form:errors path="type" cssClass="error" />
				</div>
				<label for="effectiveField" class="col-sm-2 control-label esoft-left">Effectif:&nbsp;</label>
				<div class="col-sm-4" >
					<form:select path="effective" cssClass="form-control ">
						<option value="oneToFive">1-5</option>
						<option value="sixToTen">6-10</option>
						<option value="elevenToFifty">11-50</option>
						<option value="fifty_oneToHandred">50-100</option>
						<option value="GreatherThanHandred"> >100 </option>
					</form:select>
					<form:errors path="effective" cssClass="error" />
				</div>
			</div>	
			<div class="form-group">
				<label for="nameField" class="col-sm-2 control-label esoft-left">Capital:&nbsp;</label>
				<div class="col-sm-4">
					<form:input path="capital" cssClass="form-control number"/>
					<form:errors path="capital" cssClass="error" />
				</div>
			...
			<button type="submit" class="btn-sm btn btn-primary btn pull-right" style="margin-right: 1%;"><i class="fa fa-plus"></i>&nbsp;Valider</button>
			</div>
		</form:form>
	</div>
</div>
