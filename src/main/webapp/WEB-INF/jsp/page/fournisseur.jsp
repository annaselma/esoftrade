...
<div class="form-group">
	...
	<div class="box box-primary">
		...
		<!-- form start -->
			...
			<div class="form-group">
				<label for="name" class="col-sm-1 control-label esoft-left">Name</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="name"
						placeholder="name">
				</div>
				<label for="code" class="col-sm-2 control-label">code client</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
					<label for="Fournisseur" class="col-sm-1 control-label esoft-left">Fournisseur</label>
				<div class="col-sm-4">
				...
				<label for="code" class="col-sm-2 control-label">code fournisseur</label>
				<div class="col-sm-4">
					<input type="text" class="form-control" id="code"
				...
				<div class="form-group">
							<label for="etat" class="col-sm-1 control-label esoft-left">Email</label>
						<div class="col-md-4">
				...
				<div class="form-group">
						...
						<div class="col-md-4">
							<div class="input-group">
								<span class="input-group-addon"><i class=" fa fa-globe"></i></span> <input
									type="text" class="form-control" placeholder="Web">
							</div>
						</div>
				...
				<div class="form-group">
					  <label for="postal" class="col-sm-1 control-label esoft-left">CP</label>
						<div class="col-md-4">
							<input class="form-control" id="oostal" placeholder="Entrer code postal">
						</div>
				...
				<div class="form-group">
						...
						<div class="col-md-2">
							<select class="form-control input-sm bfh-countries"
								...
								<option value="142">Macédoine (Ex-République
									yougoslave) (MK)</option>
								...
								<option value="73">République démocratique du Congo
									(CD)</option>
								...
								<option value="194">Saint-Vincent-et-les-Grenadines
									(VC)</option>
