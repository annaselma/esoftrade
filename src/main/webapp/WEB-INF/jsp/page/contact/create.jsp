...
<span class="error">Veuillez saisir les champs obligatoire (*)</span>
		<form:form method="POST" commandName="contact" id="contactF"
			data-toggle="validator" cssClass="form-horizontal">
			<div class="form-group">
				<label for="zipCodeField" class="col-sm-2 control-label esoft-left">Nom:&nbsp;<span class="error">*</span></label>
				<div class="col-sm-4">
					<form:input path="lastName"  cssClass="form-control "/>
					<form:errors path="lastName" cssClass="error" />
				</div>
				<label for="cityField" class="col-sm-2 control-label esoft-left">Prénom:&nbsp;<span class="error">*</span></label>
				<div class="col-sm-4">
			...
			<div class="form-group form-horizontal">
				<label for="statut" class="col-sm-2 control-label esoft-left">Tiers&nbsp;</label>
				<c:choose>
					<c:when test="${contact.company.id > 0}"> 
						<div class="col-sm-4" style="text-align: left;"> <a
							href="${baseURL}/third/profile?id=${contact.company.id}"><span class="fa fa-hand-o-right"></span> <c:out
									value="${contact.company.name}" /></a>
						</div>
					...
					<c:otherwise>
						<div class="col-sm-4" id="select-company">
							<form:select path="company"
								cssClass="tokenize-sample mono-select " id="company" size="1">
								<c:if test="${contact.company.id >0}">
									<form:option value="${contact.company.id}" selected="selected">
										<c:out value="${contact.company.name}" />
									</form:option>
								</c:if>
							</form:select>
						...
						<script type="text/javascript">
							$('#company').tokenize({
								"newElements" : false,
								maxElements : 1,
								datas : "${baseURL}/third/search?type=all",
								valueField : "id",
								textField : "name"
							});
							$("#select-company")
									.on(
											...
											function() {
												...
												$text = $(
														...
														.remove();
												$(
														"#select-company select option[selected='selected']")
														.remove();
												$(
														"#select-company .TokenSearch input")
														.val();
											});
						</script>
					</c:otherwise>
			...
			<hr>
			<div class="form-group">
				<label for="civilityField" class="col-sm-2 control-label esoft-left">Titre civilité:&nbsp;</label>
				<div class="col-sm-4" id="select-cat">
					<form:select path="civility" cssClass="form-control ">
			...
			<div class="form-group">
				<label for="statusField" class="col-sm-2 control-label esoft-left">état:&nbsp;</label>
				<div class="col-sm-4" id="select-cat">
					<form:select path="status" cssClass="form-control ">
						<option value="inActivity">En activité</option>
				...
				<hr>
			<div class="form-group">
				<label for="jobField" class="col-sm-2 control-label esoft-left">Poste/Fonction:</label>
				<div class="col-sm-4">
		    ...
		    <div class="form-group">
				...
				<div class="col-sm-4">
					<form:textarea path="adresse" rows="3" cols="56" cssClass="form-control" />
					<form:errors path="adresse" cssClass="error" />
				</div>
			</div>
			<div class="form-group">

				<label for="zipCodeField" class="col-sm-2 control-label esoft-left">Code Postale:</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
				...
				<label for="telField" class="col-sm-2 control-label esoft-left">Téléphone perso:</label>
				<div class="col-sm-4">
					<form:input path="telephone"  cssClass="form-control "/>
					<form:errors path="telephone" cssClass="error" />
				</div>
				<label for="faxField" class="col-sm-2 control-label esoft-left">Téléphone pro:</label>
				<div class="col-sm-4">
					<form:input path="telephonePro" cssClass="form-control " />
					<form:errors path="telephonePro" cssClass="error" />
				</div>
			</div>
			<div class="form-group">

				<label for="faxField" class="col-sm-2 control-label esoft-left">Fax:</label>
				<div class="col-sm-4">
			...
			<div class="form-group">
			<label for="webField" class="col-sm-2 control-label esoft-left">Web:</label>
				<div class="col-sm-4">
			...
			<hr>
			<div class="form-group">
				<label for="birthdayField" class="col-sm-2 control-label esoft-left">Date de Naissance:&nbsp;</label>
				 <div class="input-append date col-sm-4" data-date="12-02-1973"
